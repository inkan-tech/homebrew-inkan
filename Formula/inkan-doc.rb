class InkanDoc < Formula
  ...
  url "https://github.com/inkan-tech/inkan-doc/archive/refs/tags/v0.1.6.tar.gz"
  sha256 "0da547a51a4612c81082b7f5354f082b253cbb5b5a6530d9f1d6159ced5b9e6d"
  license "MIT"
  ...
  # For PDF generation: brew install --cask mactex
  # For PlantUML filter: uv pip install pandoc-plantuml-filter
  # For AI review workflow (OCR): uv pip install inkan-doc[review]
  #   Requires: pillow, cairosvg, anthropic, groq
  #   Note: cairosvg needs system cairo library (brew install cairo)
  ...
  test do
    assert_match "Inkan Doc", shell_output("#{bin}/inkan-doc --help")
    assert_match version.to_s, shell_output("#{bin}/inkan-doc --version")
  end
end
