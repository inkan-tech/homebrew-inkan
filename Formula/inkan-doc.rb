class InkanDoc < Formula
  ...
  desc "Document management CLI with Pandoc integration and reMarkable sync"
  homepage "https://github.com/inkan-tech/inkan-doc"
  url "https://github.com/inkan-tech/inkan-doc/archive/refs/tags/v0.1.1.tar.gz"
  ...
  # For PlantUML filter: pip install pandoc-plantuml-filter
